...
contract MerkleTreeDemo {
    ...
    //为电子病历创建默克尔树
    function constructEMRMerkleTree(bytes32 _l1, bytes32 _l2,bytes32 _l3, bytes32 _l4,bytes32 _l5, bytes32 _l6,bytes32 _l7, bytes32 _l8) public returns(bytes32){
        bytes32[] memory leafs = new bytes32[](8);
        leafs[0] = _l1;
        leafs[1] = _l2;
        leafs[2] = _l3;
        leafs[3] = _l4;
        ...
        return evenLeafsMerkleTree.root.value;
    }
